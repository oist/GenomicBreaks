...
genomes <- SimpleList(Oki = OKI2018_I69, Kum = KUM_M3, Osa = OSKA2016v1.9, Nor = OdB3)
```
...
# annots$Bar <- gff2txdb("Annotations/Bar2_p4.Flye/Bar2_p4.Flye.gm.gff", NULL)
...
mkTree <- function (Oki, Kume, Osaka, Norway) {
  ade4::newick2phylog(
    paste0(
      "(",
        "(", Oki, ":1, ",
...
tree <- mkTree("Okinawa", "Kume", "North Pacific", "Norway")
plot(tree)
```
