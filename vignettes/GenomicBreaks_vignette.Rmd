...
```{r get bps}
get_bps(gb)
get_bps(gb, direction = "left")
get_bps(gb,                      stranded = TRUE)
get_bps(gb,                      stranded = TRUE, sorted = FALSE)
get_bps(gb, direction = "right", stranded = TRUE)
get_bps(gb$query, sorted = FALSE)
get_bps(gb$query)
```
