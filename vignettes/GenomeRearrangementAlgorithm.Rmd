...
is_fortress(sum(info$superhurdle))
...
# query_sequence_nusig <- system.file("extdata/NeuCra__PodCom.III__7.gff3.gz", package = "GenomicBreaks") |> load_genomic_breaks(type = 'match') |> head(100) |> bpGraph()
# 
# start_time <- Sys.time()
# result <- inversions_rearrangement(query_sequence_unsig)
# end_time <- Sys.time()
