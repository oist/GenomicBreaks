...
Each cycle can be oriented or unoriented. So this is a node attribute. Here, blue nodes are unoriented cycles, while orange nodes are oriented cycles.
...
For each component, lets define its extension as the union of the extension of all gray edges.
