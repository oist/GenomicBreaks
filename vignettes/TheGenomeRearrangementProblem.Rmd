...
The solution for this is getting the coalescent sequence, which means turning several colinear fragments into a single fragment. Then we can know exactly the value for the breakpoints and be able to know if the pattern is a genuine combination of inversion. 
