...
coalesce_contigs(C_int_P__C_rob_HT_col, minwidth = 1e4) |> flagColinearAlignments() |> flagInversions() |> flagTranslocations() |> flagAll() |> as.data.frame()
coalesce_contigs(C_int_P__C_rob_HT_col, minwidth = 1e5) |> flagColinearAlignments() |> flagInversions() |> flagTranslocations() |> flagAll() |> as.data.frame()
```
...
# coalesce_contigs(NEAR__C_int_P__C_int_R_col, minwidth = 1e5) |> flagColinearAlignments() |> flagInversions() |> flagTranslocations() |> as.data.frame()
# 
...
# coalesce_contigs(YASS__C_int_P__C_int_R_col, minwidth = 1e5) |> flagColinearAlignments() |> flagInversions() |> flagTranslocations() |> as.data.frame()
# 
...
# coalesce_contigs(YASSW__C_int_P__C_int_R_col, minwidth = 1e5) |> flagColinearAlignments() |> flagInversions() |> flagTranslocations() |> as.data.frame()
# 
...
# coalesce_contigs(RY32__C_int_P__C_int_R_col, minwidth = 1e5) |> flagColinearAlignments() |> flagInversions() |> flagTranslocations() |> as.data.frame()
# 
...
# coalesce_contigs(RY32W__C_int_P__C_int_R_col, minwidth = 1e5) |> flagColinearAlignments() |> flagInversions() |> flagTranslocations() |> as.data.frame()
```
