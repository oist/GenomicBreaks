...
params:
  resultsDir: "~/projects/GenomicBreaks_results/results-v2.8/genomicbreaks/"
  alnDir:     "~/projects/GenomicBreaks_results/results-v2.8/last/"
  prefix: "test"
editor_options: 
...
df$speciesGroup[df$species1 %in% c("YASS")] <- "YASS"
df$speciesGroup[df$species1 %in% c("RY32")] <- "RY32"
