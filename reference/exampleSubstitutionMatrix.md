...
The probability matrix is loaded from the file `extdata/example.train`
...
An object of class `matrix` (inherits from `array`) with 6 rows and 6
columns.

## Details

The count matrix is derived from an alignment of *Oikopleura dioica*
cryptic species…
