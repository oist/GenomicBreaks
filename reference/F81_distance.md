...
The Felsenstein 1981 (F81) distance corrects for multiple substitutions
like the
[`JC69_distance()`](https://oist.github.io/GenomicBreaks/reference/JC69_distance.md)
function, but also accounts for GC content. It is calculated as \\-E
\ln\left(\frac{E - p}{E}\right)\\, where \\E\\ equals \\1\\ minus the
sum of the squares of the average nucleotide frequencies (McGuire and
coll., 1999).
...
McGuire, G., Prentice, M. J., & Wright, F. (1999). Improved error bounds
for genetic distances from DNA sequences. *Biometrics*, 55(4),
1064–1070.
[doi:10.1111/j.0006-341x.1999.01064.x](https://doi.org/10.1111/j.0006-341x.1999.01064.x)
